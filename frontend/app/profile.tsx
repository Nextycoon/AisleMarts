  ...
  const menuSections: MenuSection[] = [
    ...
    },
    {
      ...
      items: [
        {
          id: '10',
          title: 'Global Monetization Suite',
          icon: '💰',
          subtitle: '8 revenue streams • Series A ready',
          route: '/(tabs)/global-monetization-dashboard',
          badge: 'SERIES A',
        },
        {
          id: '10a',
          ...
          icon: '🌍',
          subtitle: 'AislePay, services, AI assistant',
          route: '/(tabs)/super-app-dashboard',
          badge: 'NEW',
        },
        {
          id: '10b',
          ...
          icon: '🤖',
          subtitle: 'AI personalization & insights',
          route: '/(tabs)/advanced-ai-dashboard',
          badge: 'AI',
        },
        {
          id: '11',
          ...
          icon: '📡',
          subtitle: 'AI-powered live commerce',
          route: '/(tabs)/live-streaming-commerce',
          badge: 'LIVE',
        },
        {
          id: '12',
          ...
          icon: '📊',
          subtitle: 'Retention & behavior analytics',
          route: '/(tabs)/ai-analytics-dashboard',
          badge: 'ANALYTICS',
        },
        {
          id: '13',
          ...
          icon: '🎬',
          subtitle: 'Content monetization tools',
        ...
        },
        {
          ...
          icon: '🏢',
          subtitle: 'Trust badges & verification',
