...
# Configuration
FASTAPI_BASE_URL = "https://aislefeed.preview.emergentagent.com/api"
EXPRESS_BASE_URL = "https://aislefeed.preview.emergentagent.com"  # Express server on port 8002 if available
