...
# Configuration
FASTAPI_BASE_URL = "https://marketplace-docs.preview.emergentagent.com/api"
EXPRESS_BASE_URL = "https://marketplace-docs.preview.emergentagent.com"  # Express server on port 8002 if available
