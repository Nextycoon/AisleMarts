...
# Configuration
FASTAPI_BASE_URL = "https://infinity-stories.preview.emergentagent.com/api"
EXPRESS_BASE_URL = "https://infinity-stories.preview.emergentagent.com"  # Express server on port 8002 if available
