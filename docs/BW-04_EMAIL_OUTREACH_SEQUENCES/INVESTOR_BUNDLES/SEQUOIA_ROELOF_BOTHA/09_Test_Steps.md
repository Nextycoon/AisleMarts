...
## Pre-Test Setup ✅
- [ ] Demo environment: https://aislemart-superapp.preview.emergentagent.com
...
### Test URL
```
https://aislemart-superapp.preview.emergentagent.com/?locale=en-US&currency=USD&tz=America/Los_Angeles&device=desktop&utm_source=investor&utm_medium=email&utm_campaign=series_a&utm_bundle=SEQUOIA_ROELOF_BOTHA
```
...
### Test URL
```
https://aislemart-superapp.preview.emergentagent.com/mood-to-cart?preset=luxurious&locale=en-US&currency=USD&network_effects=true&utm_bundle=SEQUOIA_ROELOF_BOTHA
```
...
### Test URL
```
https://aislemart-superapp.preview.emergentagent.com/livesale/LS-SEQ-001?locale=en-US&currency=USD&show_network_metrics=true&utm_bundle=SEQUOIA_ROELOF_BOTHA
```
...
### Test Procedure
1. Access: `https://aislemart-superapp.preview.emergentagent.com/chat?demo_mode=investor&locale=en-US`
2. Start conversation with demo prospect
3. Convert to business lead: `https://aislemart-superapp.preview.emergentagent.com/business/leads`
...
### Test URL
```
https://aislemart-superapp.preview.emergentagent.com/analytics?view=investor&currency=USD&focus=network_effects&timeframe=30d&utm_bundle=SEQUOIA_ROELOF_BOTHA
```
