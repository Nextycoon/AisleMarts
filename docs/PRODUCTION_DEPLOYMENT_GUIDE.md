...
### **Development/Staging**
```
Development: https://aislemart-superapp.preview.emergentagent.com
Staging API: https://aislemart-superapp.preview.emergentagent.com/api
Testing Suite: https://aislemart-superapp.preview.emergentagent.com/test
```
