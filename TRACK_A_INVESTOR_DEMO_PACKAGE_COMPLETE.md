...
echo 'EXPO_PUBLIC_API_URL=https://aislemart-global.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://aislemart-global.preview.emergentagent.com`
...
curl -s https://aislemart-global.preview.emergentagent.com/health
curl -s https://aislemart-global.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://aislemart-global.preview.emergentagent.com/api/ai/chat
curl -s https://aislemart-global.preview.emergentagent.com/api/ai/recommendations
```
