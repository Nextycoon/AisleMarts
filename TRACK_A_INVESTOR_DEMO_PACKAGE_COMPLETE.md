...
echo 'EXPO_PUBLIC_API_URL=https://aislemarts-staging.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://aislemarts-staging.preview.emergentagent.com`
...
curl -s https://aislemarts-staging.preview.emergentagent.com/health
curl -s https://aislemarts-staging.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://aislemarts-staging.preview.emergentagent.com/api/ai/chat
curl -s https://aislemarts-staging.preview.emergentagent.com/api/ai/recommendations
```
