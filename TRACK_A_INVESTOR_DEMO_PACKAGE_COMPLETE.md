...
echo 'EXPO_PUBLIC_API_URL=https://social-tiktok-mart.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://social-tiktok-mart.preview.emergentagent.com`
...
curl -s https://social-tiktok-mart.preview.emergentagent.com/health
curl -s https://social-tiktok-mart.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://social-tiktok-mart.preview.emergentagent.com/api/ai/chat
curl -s https://social-tiktok-mart.preview.emergentagent.com/api/ai/recommendations
```
