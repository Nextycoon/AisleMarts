...
echo 'EXPO_PUBLIC_API_URL=https://retail-fusion-5.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://retail-fusion-5.preview.emergentagent.com`
...
curl -s https://retail-fusion-5.preview.emergentagent.com/health
curl -s https://retail-fusion-5.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://retail-fusion-5.preview.emergentagent.com/api/ai/chat
curl -s https://retail-fusion-5.preview.emergentagent.com/api/ai/recommendations
```
