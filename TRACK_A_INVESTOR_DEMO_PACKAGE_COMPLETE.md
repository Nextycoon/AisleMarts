...
echo 'EXPO_PUBLIC_API_URL=https://lux-aware.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://lux-aware.preview.emergentagent.com`
...
curl -s https://lux-aware.preview.emergentagent.com/health
curl -s https://lux-aware.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://lux-aware.preview.emergentagent.com/api/ai/chat
curl -s https://lux-aware.preview.emergentagent.com/api/ai/recommendations
```
