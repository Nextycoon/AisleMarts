...
echo 'EXPO_PUBLIC_API_URL=https://unified-retail-ai.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://unified-retail-ai.preview.emergentagent.com`
...
curl -s https://unified-retail-ai.preview.emergentagent.com/health
curl -s https://unified-retail-ai.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://unified-retail-ai.preview.emergentagent.com/api/ai/chat
curl -s https://unified-retail-ai.preview.emergentagent.com/api/ai/recommendations
```
