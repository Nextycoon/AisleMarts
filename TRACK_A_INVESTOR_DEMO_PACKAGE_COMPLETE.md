...
echo 'EXPO_PUBLIC_API_URL=https://smart-shop-rewards.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://smart-shop-rewards.preview.emergentagent.com`
...
curl -s https://smart-shop-rewards.preview.emergentagent.com/health
curl -s https://smart-shop-rewards.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://smart-shop-rewards.preview.emergentagent.com/api/ai/chat
curl -s https://smart-shop-rewards.preview.emergentagent.com/api/ai/recommendations
```
