...
echo 'EXPO_PUBLIC_API_URL=https://cinematic-aislemarts.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://cinematic-aislemarts.preview.emergentagent.com`
...
curl -s https://cinematic-aislemarts.preview.emergentagent.com/health
curl -s https://cinematic-aislemarts.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://cinematic-aislemarts.preview.emergentagent.com/api/ai/chat
curl -s https://cinematic-aislemarts.preview.emergentagent.com/api/ai/recommendations
```
