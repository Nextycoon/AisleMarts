...
echo 'EXPO_PUBLIC_API_URL=https://lifestyle-universe.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://lifestyle-universe.preview.emergentagent.com`
...
curl -s https://lifestyle-universe.preview.emergentagent.com/health
curl -s https://lifestyle-universe.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://lifestyle-universe.preview.emergentagent.com/api/ai/chat
curl -s https://lifestyle-universe.preview.emergentagent.com/api/ai/recommendations
```
