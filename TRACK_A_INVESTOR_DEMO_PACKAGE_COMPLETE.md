...
echo 'EXPO_PUBLIC_API_URL=https://bluewave-social.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://bluewave-social.preview.emergentagent.com`
...
curl -s https://bluewave-social.preview.emergentagent.com/health
curl -s https://bluewave-social.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://bluewave-social.preview.emergentagent.com/api/ai/chat
curl -s https://bluewave-social.preview.emergentagent.com/api/ai/recommendations
```
