...
echo 'EXPO_PUBLIC_API_URL=https://marketplace-docs.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://marketplace-docs.preview.emergentagent.com`
...
curl -s https://marketplace-docs.preview.emergentagent.com/health
curl -s https://marketplace-docs.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://marketplace-docs.preview.emergentagent.com/api/ai/chat
curl -s https://marketplace-docs.preview.emergentagent.com/api/ai/recommendations
```
