...
echo 'EXPO_PUBLIC_API_URL=https://luxury-social-suite.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://luxury-social-suite.preview.emergentagent.com`
...
curl -s https://luxury-social-suite.preview.emergentagent.com/health
curl -s https://luxury-social-suite.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://luxury-social-suite.preview.emergentagent.com/api/ai/chat
curl -s https://luxury-social-suite.preview.emergentagent.com/api/ai/recommendations
```
