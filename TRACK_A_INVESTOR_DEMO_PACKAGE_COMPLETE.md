...
echo 'EXPO_PUBLIC_API_URL=https://stories-marketplace.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://stories-marketplace.preview.emergentagent.com`
...
curl -s https://stories-marketplace.preview.emergentagent.com/health
curl -s https://stories-marketplace.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://stories-marketplace.preview.emergentagent.com/api/ai/chat
curl -s https://stories-marketplace.preview.emergentagent.com/api/ai/recommendations
```
