...
echo 'EXPO_PUBLIC_API_URL=https://seriesaready.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://seriesaready.preview.emergentagent.com`
...
curl -s https://seriesaready.preview.emergentagent.com/health
curl -s https://seriesaready.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://seriesaready.preview.emergentagent.com/api/ai/chat
curl -s https://seriesaready.preview.emergentagent.com/api/ai/recommendations
```
