...
echo 'EXPO_PUBLIC_API_URL=https://social-ecosystem.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://social-ecosystem.preview.emergentagent.com`
...
curl -s https://social-ecosystem.preview.emergentagent.com/health
curl -s https://social-ecosystem.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://social-ecosystem.preview.emergentagent.com/api/ai/chat
curl -s https://social-ecosystem.preview.emergentagent.com/api/ai/recommendations
```
