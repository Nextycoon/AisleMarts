...
echo 'EXPO_PUBLIC_API_URL=https://shopstream-app.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://shopstream-app.preview.emergentagent.com`
...
curl -s https://shopstream-app.preview.emergentagent.com/health
curl -s https://shopstream-app.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://shopstream-app.preview.emergentagent.com/api/ai/chat
curl -s https://shopstream-app.preview.emergentagent.com/api/ai/recommendations
```
