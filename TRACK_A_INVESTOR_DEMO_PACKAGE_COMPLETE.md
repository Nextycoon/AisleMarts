...
echo 'EXPO_PUBLIC_API_URL=https://mood-to-cart.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://mood-to-cart.preview.emergentagent.com`
...
curl -s https://mood-to-cart.preview.emergentagent.com/health
curl -s https://mood-to-cart.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://mood-to-cart.preview.emergentagent.com/api/ai/chat
curl -s https://mood-to-cart.preview.emergentagent.com/api/ai/recommendations
```
