...
echo 'EXPO_PUBLIC_API_URL=https://vendor-dashboard-10.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://vendor-dashboard-10.preview.emergentagent.com`
...
curl -s https://vendor-dashboard-10.preview.emergentagent.com/health
curl -s https://vendor-dashboard-10.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://vendor-dashboard-10.preview.emergentagent.com/api/ai/chat
curl -s https://vendor-dashboard-10.preview.emergentagent.com/api/ai/recommendations
```
