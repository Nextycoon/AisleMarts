...
echo 'EXPO_PUBLIC_API_URL=https://market-launch-4.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://market-launch-4.preview.emergentagent.com`
...
curl -s https://market-launch-4.preview.emergentagent.com/health
curl -s https://market-launch-4.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://market-launch-4.preview.emergentagent.com/api/ai/chat
curl -s https://market-launch-4.preview.emergentagent.com/api/ai/recommendations
```
