...
echo 'EXPO_PUBLIC_API_URL=https://voice-commerce.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://voice-commerce.preview.emergentagent.com`
...
curl -s https://voice-commerce.preview.emergentagent.com/health
curl -s https://voice-commerce.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://voice-commerce.preview.emergentagent.com/api/ai/chat
curl -s https://voice-commerce.preview.emergentagent.com/api/ai/recommendations
```
