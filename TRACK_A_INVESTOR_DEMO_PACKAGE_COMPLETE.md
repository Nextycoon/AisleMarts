...
echo 'EXPO_PUBLIC_API_URL=https://aislefeed.preview.emergentagent.com' >> .env.production
...
**Live Demo URL**: `https://aislefeed.preview.emergentagent.com`
...
curl -s https://aislefeed.preview.emergentagent.com/health
curl -s https://aislefeed.preview.emergentagent.com/api/products/collections

# 3. Test investor-critical APIs
curl -s https://aislefeed.preview.emergentagent.com/api/ai/chat
curl -s https://aislefeed.preview.emergentagent.com/api/ai/recommendations
```
